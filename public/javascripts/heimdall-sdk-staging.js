        ...
        return {
            createInstance: function(info, callback) {
                if (info.token) {
                    ...
                    window.open(`https://heimdall.stgc0.uswest2.c-e.works/v1/application?elementKey=${info.elementKey}&userSecret=${info.userSecret}&applicationId=${info.applicationId}&uniqueName=${info.uniqueName}&instanceId=${info.instanceId}`)
                } else {
